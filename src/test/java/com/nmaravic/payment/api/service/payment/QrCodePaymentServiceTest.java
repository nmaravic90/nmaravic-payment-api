...
class QrCodePaymentServiceTest {
    ...
    @InjectMocks
    private QrCodePaymentService service;
    ...
    @Test
    void getPaymentType_shouldReturnQrCode() {
        assertThat(service.getPaymentType()).isEqualTo(PaymentType.QR_CODE);
    }
    ...
    void validateAndDeduct_shouldCallBalanceService() {
        ...
        verify(balanceService).validateAndSubtractBalance("user_001", BigDecimal.valueOf(150.00));
    }
